 ...
 *
 * File purpose:
 * - Provides minimal C library syscall stubs required by the embedded runtime.
 *
 * Functions in this file:
 * - _exit: terminates execution in the embedded runtime.
 * - _close: stubbed file close syscall.
 * - _execve: stubbed process execution syscall.
 * - _fork: stubbed process creation syscall.
 * - _fstat: reports a character-device file type.
 * - _getpid: returns a dummy process id.
 * - _isatty: reports terminal-like behavior for standard streams.
 * - _kill: stubbed signal delivery syscall.
 * - _link: stubbed filesystem link syscall.
 * - _lseek: stubbed file seek syscall.
 * - _open: stubbed file open syscall.
 * - _read: reads from the weak character input hook.
 * - _stat: stubbed file stat syscall.
 * - _times: stubbed process time syscall.
 * - _unlink: stubbed filesystem unlink syscall.
 * - _wait: stubbed wait syscall.
 * - _write: writes to the weak character output hook.
 *
